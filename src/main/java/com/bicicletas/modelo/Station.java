public class Station {
    ...
    public boolean asignarBicicleta(Bike bicicleta) {
    return agregarBicicleta(bicicleta);
}

public boolean devolverBicicleta(Bike bicicleta) {
    return retirarBicicleta(bicicleta);
}
